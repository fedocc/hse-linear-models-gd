...
Notebook сохранён с outputs: графиками, таблицами и метриками. Формулировки исходной домашней работы удалены, чтобы репозиторий читался как исследовательский отчёт.
